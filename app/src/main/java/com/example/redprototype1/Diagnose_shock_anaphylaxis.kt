...
import kotlinx.android.synthetic.main.activity_diagnose_shock_anaphylaxis.*

class Diagnose_shock_anaphylaxis : AppCompatActivity() {

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_diagnose_shock_anaphylaxis)
