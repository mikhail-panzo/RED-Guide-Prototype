...
import kotlinx.android.synthetic.main.activity_diagnose_shock_sepsis.*

class Diagnose_shock_sepsis : AppCompatActivity() {

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_diagnose_shock_sepsis)
