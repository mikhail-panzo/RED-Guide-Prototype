...
import kotlinx.android.synthetic.main.activity_diagnose_shock_cardiogenic.*

class Diagnose_shock_cardiogenic : AppCompatActivity() {

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_diagnose_shock_cardiogenic)
