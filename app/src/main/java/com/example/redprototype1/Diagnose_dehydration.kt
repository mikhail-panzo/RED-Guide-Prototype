...
import kotlinx.android.synthetic.main.activity_diagnose_dehydration.*

class Diagnose_dehydration : AppCompatActivity() {

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_diagnose_dehydration)
